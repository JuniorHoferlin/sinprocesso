...
class InsumoProcesso extends RelatorioBase
{
     ...
     * @var string
     */
    protected $titulo = 'Insumos por processo';
     ...
     * @var string
     */
    protected $view = 'relatorios.insumo_processo.imprimir';
    ...
    {
        $dados = Processo::with('area', 'tarefas.dados');
