...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <input type="text" autofocus name="descricao" id="descricao" class="form-control" value="{{ isset($funcao) ? $funcao->descricao : '' }}" placeholder="Descrição" required>
    </div>
</div>
...
<div class="text-right">
    <a href="{{ route('funcoes.index') }}" class="btn btn-default" data-dismiss="modal">Cancelar</a>
