...
@section('conteudo')
    <form class="validate" method="post" id="form-termo_referencia" role="form" action="{{ route('termo_referencia.alterar.post', $termoReferencia->id) }}" enctype="multipart/form-data">
        <div class="termo_referencia add panel panel-default navbar-default-new">
            <div class="panel-heading">
                <div class="panel-title m-b-md">
                    <h1>Alterar Termo de referência</h1>
                </div>
                <hr>
                <div class="panel-options">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="{{ $aba == 'insumos_existentes' ? 'active' : '' }}">
                            <a data-toggle="tab" href="#insumos_existentes">
                                Modificar insumos
                            </a>
                        </li>
            ...
            <div class="panel-body">
                <div class="tab-content">
                    ...
                    <div id="insumos_existentes" class="tab-pane {{ $aba == 'insumos_existentes' ? 'active' : '' }}">
                        @include('termo_referencia.insumos_existentes')
                        <div class="clearfix"></div>
                    </div>
