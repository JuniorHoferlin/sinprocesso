...
@section('conteudo')
    <div class="andamento-tarefa lista panel panel-default">
        <div class="panel-body">
            <h1>Relatório de insumos por processo</h1>
            <hr/>
            <form action="{{ route('insumo_processo.index') }}" method="get" class="form-filter">
                <div class="well">
                    <div class="row">
                    ...
                    <div class="text-right">
                        @include('partials.botao_limpar', ['url' => route('insumo_processo.index')])
            ...
            <div class="table-responsive">
                @include('relatorios.insumo_processo.listagem')
                @if ($dados)
